...
VALUES ('1', '1', 'Egy macska élete', 'MacskaAdó Kft. & Kis Pista', '50000');
GO
INSERT INTO FTORZS (FAZON, FTIPUS, FCIM, FKIAD, FHDIJ)
VALUES ('2', '2', 'Egy macska élete a családban', 'MacskaSzedő Kft. & Nagy Béla', '60000');
GO
INSERT INTO FTORZS (FAZON, FTIPUS, FCIM, FKIAD, FHDIJ)
VALUES ('3', '3', 'Egy macska élete a tudományban', 'MacskaKenő Kft. & Közepes János', '70000');
GO
/*------------------------------------------------------------------------*/
